    ...
    <div class="col-lg-6 mb-7 d-flex" >
            ...
            <div class="mb-3 mx-5 col-lg-6" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        @php
                            $style= 'style="background-image: url('.(!empty($staff->profile_image) ? $staff->profile_image : 
                            asset('assets/image/post-image/post-17.jpg')).')"';
                        @endphp
                        <div class="image previewImage" id="exampleInputImage" 
                                {!! $style !!}>
                        </div>
                        ...
                        <label> 
                            <i class="fa-solid fa-pen" id="profileImageIcon"></i> 
                            <input type="file" name="cover_image" class="image-upload d-none" accept="image/*"/>
                        </label> 
                    </span>
                    </div>
                </div>
