...
{{--                                                <button class="btn btn-primary px-2 py-0 fs-14">Follow</button>--}}
                                            ...
                                            <a href="{{route('userDetails',$follow->follower->id)}}" class="text-dark">{{$follow->follower->full_name}}</a>
...
{{--                                                <button class="btn btn-primary px-2 py-0 fs-14">Follow</button>--}}
                                            ...
                                            <a href="{{route('userDetails',$follow->follow->id)}}" class="text-dark">{{$follow->follow->full_name}}</a>
