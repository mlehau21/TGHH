...
function validatePostForm() {
    ...
    if (isEmpty($.trim(slug))) {
        ...
        toastr.error(
            Lang.get("messages.common.max", { attribute: "slug", max: 180 })
        );
        return false;
    }
    if (isEmpty($.trim(description))) {
        toastr.error(
            Lang.get("messages.common.required", { attribute: "description" })
        );
        return false;
    }
    ...
    if (isEmpty($.trim(keywords))) {
        ...
        toastr.error(
            Lang.get("messages.common.max", { attribute: "keywords", max: 180 })
        );
        return false;
    }
    ...
    if (isEmpty($.trim(tags))) {
        ...
        toastr.error(
            Lang.get("messages.common.max", { attribute: "tags", max: 180 })
        );
        return false;
    }
    ...
    if (scheduledPost && isEmpty(datePicker)) {
        toastr.error(
            Lang.get("messages.common.required", { attribute: "date & time" })
        );
        return false;
    }
        ...
        success: function (response) {
            ...
            $("#subCategoryFilter").append(
                $('<option value=""></option>').text(
                    Lang.get("messages.common.select_subcategory")
                )
            );
