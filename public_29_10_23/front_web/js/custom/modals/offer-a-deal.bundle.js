    ...
    return {
        init: function () {
            (a = KTModalOfferADeal.getForm()),
                ...
                $(
                    a.querySelector('[name="details_activation_date"]')
                ).flatpickr({ enableTime: !0, dateFormat: "d, M Y, H:i" }),
                $(a.querySelector('[name="details_customer"]')).on(
                    "change",
                    function () {
                        o.revalidateField("details_customer");
                    }
                ),
                (o = FormValidation.formValidation(a, {
                    fields: {
                        details_customer: {
                            validators: {
        ...
        init: function () {
            (a = KTModalOfferADeal.getForm()),
                ...
                KTDialer.getInstance(
                    a.querySelector("#kt_modal_finance_setup")
                ).on("kt.dialer.changed", function () {
                    o.revalidateField("finance_setup");
                }),
                e.addEventListener("click", function (t) {
                    t.preventDefault(),
                        (e.disabled = !0),
    ...
    return {
        init: function () {
            (o = KTModalOfferADeal.getForm()),
                (a = KTModalOfferADeal.getStepperObj()),
